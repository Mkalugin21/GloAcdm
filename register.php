...
<!--						<div class="valid-feedback">Все ок</div>-->
					...
					<div class="mb-3">
						...
						<input name="pass" type="password" class="form-control" id="password-input" required>
<!--						<div class="invalid-feedback">А тут не ок</div>-->
					</div>
					<div class="mb-3">
						<label for="password-input2" class="form-label">Пароль еще раз</label>
						<input name="pass2" type="password" class="form-control" id="password-input2" required>
